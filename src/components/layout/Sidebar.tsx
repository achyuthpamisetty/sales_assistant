...
const Sidebar: React.FC<SidebarProps> = ({ open, setOpen }) => {
  ...
  const adminNavigation = [
    ...
    { name: 'Integrations', href: '/pages/admin/Integrations', icon: Plug },
  ...
  return (
    <>
      <div 
        className={`fixed inset-y-0 left-0 z-20 w-64 transform bg-white shadow-lg transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:inset-auto lg:h-screen lg:w-64 ${
